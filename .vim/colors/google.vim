																																																    ...
																																																    let s:GREY0  = s:BLACK
																																																	  let s:GREY1  = s:DGREY
																																																	    let s:GREY2  = s:LGREY
																																																		  ...
																																																		  exe 'hi Normal       '.s:M.'fg='.s:BLUE .' '.s:M.'=none'
																																																		  exe 'hi Identifier   '.s:M.'fg='.s:BLUE .' '.s:M.'=bold'
																																																		  exe 'hi Function     '.s:M.'fg='.s:GREEN .' '.s:M.'=bold'
																																																		  ...
																																																		  exe 'hi Todo         '.s:M.'bg='.s:YELLOW.' '.s:M.'=none'
																																																		  exe 'hi WildMenu     '.s:M.'bg='.s:YELLOW.' '.s:M.'=none'
																																																		  ...
																																																		  exe 'hi Cursor       '.s:M.'bg='.s:GREY1.' '.s:M.'=bold'
																																																		  exe 'hi Search       '.s:M.'bg='.s:YELLOW.' '.s:M.'=none'
																																																		  exe 'hi IncSearch    '.s:M.'bg='.s:YELLOW.' '.s:M.'=none'
																																																		  exe 'hi ColorColumn  '.s:M.'bg='.s:GREY2.' '.s:M.'fg='.'NONE' .' '.s:M.'=none'
																																																		  exe 'hi SignColumn   '.s:M.'bg='.s:GREY2.' '.s:M.'fg='.s:YELLOW.' '.s:M.'=none'

																																																		  exe 'hi WarningMsg   '.s:M.'fg='.s:RED  .' '.s:M.'=bold'
																																																		  exe 'hi ErrorMsg     '.s:M.'fg='.s:RED  .' '.s:M.'=bold'
																																																		  exe 'hi ModeMsg      '.s:M.'fg='.s:BLUE .' '.s:M.'=bold'
																																																		  exe 'hi MoreMsg      '.s:M.'fg='.s:BLUE .' '.s:M.'=bold'
																																																		  exe 'hi Question     '.s:M.'fg='.s:BLUE .' '.s:M.'=bold'
																																																		  exe 'hi Directory    '.s:M.'fg='.s:GREEN.' '.s:M.'=none'
																																																		  exe 'hi SpecialKey   '.s:M.'fg='.s:GREY0.' '.s:M.'=none'
																																																		  exe 'hi Titled       '.s:M.'fg='.s:GREY0.' '.s:M.'=none'
																																																		  exe 'hi NonText      '.s:M.'fg='.s:GREY1.' '.s:M.'=bold'
																																																		  exe 'hi CursorLineNr '.s:M.'fg='.s:GREY1.' '.s:M.'=bold'

																																																		  exe 'hi PmenuSel     '.s:M.'bg='.s:BLUE .' '.s:M.'fg='.s:GREY0.' '.s:M.'=none'
																																																		  exe 'hi PmenuSBar    '.s:M.'bg='.s:GREY2.' '.s:M.'fg='.s:GREY0.' '.s:M.'=none'
																																																		  exe 'hi PmenuThumb   '.s:M.'bg='.s:GREY0.' '.s:M.'=none'
...
hi Error ctermbg=none ctermfg=000000
hi CursorLine ctermfg=NONE ctermbg=255 cterm=NONE guifg=NONE guibg=#E0E0E0 gui=NONE
