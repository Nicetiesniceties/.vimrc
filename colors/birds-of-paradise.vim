...
if exists("syntax_on")
      ...
      hi cformat ctermfg=71 ctermbg=NONE cterm=NONE guifg=#6c99bb guibg=NONE gui=NONE
	  ...
	  hi Number ctermfg=203 ctermbg=NONE cterm=NONE guifg=#6c99bb guibg=NONE gui=NONE
	  hi Operator ctermfg=67 ctermbg=NONE cterm=NONE guifg=#ef5d32 guibg=NONE gui=NONE
	  ...
	  hi rubyFunction ctermfg=71 ctermbg=NONE cterm=NONE guifg=#efac32 guibg=NONE gui=NONE
